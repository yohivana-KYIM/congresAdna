<template>
  <div class="flex items-center justify-center min-h-screen p-4 bg-gradient-to-br from-blue-900 to-yellow-700 animate-gradient-bg">
    <div class="w-full max-w-md overflow-hidden transition-all duration-500 bg-black bg-opacity-50 shadow-2xl rounded-2xl hover:bg-opacity-60 hover:shadow-yellow-400/50 transform hover:scale-105">
      <div class="p-6 space-y-4">
        ...
        <div class="flex items-center justify-between">
          <button @click="skipBackward" class="focus:outline-none transform hover:scale-110 transition-transform duration-300">
          ...
          <button @click="togglePlayPause" class="focus:outline-none transform hover:scale-110 transition-transform duration-300 animate-pulse-slow">
          ...
          <button @click="skipForward" class="focus:outline-none transform hover:scale-110 transition-transform duration-300">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-8 h-8 text-yellow-400 transition-colors duration-300 hover:text-yellow-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
