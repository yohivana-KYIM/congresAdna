<template>
  <div class="flex items-center justify-center min-h-screen p-4 bg-gradient-to-br from-blue-900 to-yellow-700">
    <div class="w-full max-w-md overflow-hidden transition-all duration-500 bg-black bg-opacity-50 shadow-2xl rounded-2xl hover:bg-opacity-60">
      <div class="p-6 space-y-4">
        ...
        <div class="flex items-center justify-between">
          <button @click="rewind" class="focus:outline-none">
          ...
          <button @click="togglePlayPause" class="focus:outline-none">
            <svg v-if="isPlaying" xmlns="http://www.w3.org/2000/svg" class="w-12 h-12 text-yellow-400 transition-colors duration-300 hover:text-yellow-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 9v6m4-6v6m-8 9a9 9 0 100-18 9 9 0 000 18z" />
            </svg>
          ...
          <button @click="forward" class="focus:outline-none">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-8 h-8 text-yellow-400 transition-colors duration-300 hover:text-yellow-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 5l7 7m0 0l-7 7m7-7H3" />
            </svg>
          </button>
        </div>

        <!-- Affichage du temps audio -->
        ...
        <div class="w-full h-2 bg-gray-200 rounded-full dark:bg-gray-700">
          <div
            class="h-2 transition-all duration-300 ease-out bg-yellow-600 rounded-full"
...
// Avancer et reculer de 10 secondes
const forward = () => {
