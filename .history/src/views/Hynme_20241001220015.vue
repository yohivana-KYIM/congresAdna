      ...
      <div class="p-6 space-y-4">
        ...
        <div class="flex items-center justify-between">
          <button @click="togglePlayPause" class="focus:outline-none">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-12 h-12 text-yellow-400 transition-colors duration-300 hover:text-yellow-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
