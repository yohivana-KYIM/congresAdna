    ...
    <div class="container px-4 mx-auto">
      <div class="flex items-center justify-center space-x-10">
        ...
        <div class="items-center hidden space-x-4 md:flex">
          ...
          <div @click="toggleSubmenu('langue')" class="cursor-pointer flex flex-col items-center hover:bg-[#8b6b10] rounded-lg px-2 py-1 transition-all duration-300">
            <div class="icon-circle bg-[#FF6347]">
              <img src="/images/menu/hymne.svg" alt="Langue" class="w-6 h-6">
            </div>
            <span class="mt-1 text-xs">Traduction</span>
          </div>
          <select v-model="selectedLanguage" @change="handleLanguageChange" class="text-white transition-all duration-300 bg-gray-700 nav-select hover:bg-gray-600">
