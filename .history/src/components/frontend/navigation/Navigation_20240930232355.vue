    ...
    <div class="container px-4 mx-auto">
      <div class="flex items-center justify-center space-x-10">
        ...
        <div class="relative">
          ...
          <div v-if="openSubmenu === 'accueil'" class="absolute z-10 w-64 py-1 mt-2 text-gray-700 bg-white rounded-md shadow-lg">
            <a v-for="(item, index) in accueilItems" :key="index" href="#" class="block px-4 py-2 text-sm hover:bg-gray-100">
              {{ item }}
            </a>
          </div>
        </div>
      ...
      <transition name="slide-fade">
        <div v-if="isMenuOpen" class="mt-4 md:hidden">
          <div class="mb-4 nav-item" @click="toggleSubmenu('accueil')">
            ...
            <div v-if="openSubmenu === 'accueil'" class="py-1 mt-2 text-gray-700 bg-white rounded-md shadow-lg">
              <a v-for="(item, index) in accueilItems" :key="index" href="#" class="block px-4 py-2 text-sm hover:bg-gray-100">
                {{ item }}
              </a>
            </div>
