    ...
    <div class="container px-4 mx-auto">
      <div class="flex items-center justify-center space-x-10">
        ...
        <div class="items-center hidden space-x-4 md:flex">
          ...
          <!-- Language selector with icon and 'Traduction' text below -->
          <div class="relative flex flex-col items-center hover:bg-[#8b6b10] rounded-lg px-2 py-1 transition-all duration-300">
            ...
            <select v-model="selectedLanguage" @change="handleLanguageChange" class="mt-1 text-white bg-gray-700 nav-select hover:bg-gray-600">
