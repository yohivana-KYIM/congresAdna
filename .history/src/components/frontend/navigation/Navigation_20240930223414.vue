        ...
        <div class="items-center hidden space-x-4 md:flex">
          ...
          <div class="relative flex flex-col items-center">
            ...
            <div class="flex items-center mt-1">
              <span class="mr-1 text-xs">Traduction</span>
              <select v-model="selectedLanguage" @change="handleLanguageChange" class="text-white bg-site bg-transparent nav-select hover:bg-gray-600">
                <option value="fr" class="bg-transparent">FR</option>
                <option value="en" class="bg-transparent">EN</option>
              </select>
            </div>
          </div>
        </div>
          ...
          <div class="mb-4 nav-item">
            <div class="flex flex-col items-center">
              ...
              <div class="flex items-center">
                ...
                <select v-model="selectedLanguage" @change="handleLanguageChange" class="ml-1 text-white bg-site bg-transparent nav-select hover:bg-gray-600">
                  <option value="fr" class="bg-transparent">FR</option>
                  <option value="en" class="bg-transparent">EN</option>
                </select>
              </div>
