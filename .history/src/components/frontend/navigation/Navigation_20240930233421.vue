  ...
  <nav class="bg-[#9C7C13] text-white py-2">
    <div class="container px-4 mx-auto">
      <div class="flex items-center justify-center space-x-10">
        ...
        <div class="relative">
          <div @click="toggleSubmenu('accueil')" class="nav-item cursor-pointer hover:bg-opacity-70 rounded-lg px-2 py-1 transition-all duration-300 bg-opacity-50">
        ...
        <div @click="toggleSubmenu('congres')" class="nav-item cursor-pointer hover:bg-opacity-70 rounded-lg px-2 py-1 transition-all duration-300 bg-opacity-50">
        ...
        <div @click="toggleSubmenu('participer')" class="nav-item cursor-pointer hover:bg-opacity-70 rounded-lg px-2 py-1 transition-all duration-300 bg-opacity-50">
        ...
        <div class="items-center hidden space-x-4 md:flex">
          <div @click="toggleSubmenu('mediatheque')" class="cursor-pointer flex flex-col items-center hover:bg-opacity-70 rounded-lg px-2 py-1 transition-all duration-300 bg-opacity-50">
          ...
          <div @click="toggleSubmenu('hymne')" class="cursor-pointer flex flex-col items-center hover:bg-opacity-70 rounded-lg px-2 py-1 transition-all duration-300 bg-opacity-50">
      ...
      <transition name="slide-fade">
        <div v-if="isMenuOpen" class="mt-4 md:hidden">
          <div class="mb-4 nav-item" @click="toggleSubmenu('mediatheque')">
            <div class="cursor-pointer flex flex-col items-center hover:bg-opacity-70 rounded-lg px-2 py-1 transition-all duration-300 bg-opacity-50">
              <div class="icon-circle bg-[#DAA520]">
                <img src="/images/menu/Médiathèque.svg" alt="Médiathèque" class="w-6 h-6">
              </div>
              <span class="mt-1 text-xs">Médiathèque</span>
