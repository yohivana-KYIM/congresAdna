        ...
        <div class="items-center hidden space-x-4 md:flex">
          ...
          <div class="relative flex flex-col items-center">
            ...
            <div class="flex items-center mt-1">
              ...
              <select v-model="selectedLanguage" @change="handleLanguageChange" class="ml-1 text-white bg-transparent bg-site hover:bg-gray-600 nav-select">
          ...
          <div class="mb-4 nav-item">
            <div class="flex flex-col items-center">
              ...
              <div class="flex items-center">
                <span class="text-xs">Traduction</span>
                <select v-model="selectedLanguage" @change="handleLanguageChange" class="ml-1 text-white bg-transparent bg-site nav-select hover:bg-gray-600">
                  <option value="fr">FR</option>
                  <option value="en">EN</option>
                </select>
              </div>
...
.nav-select {
  @apply bg-site bg-transparent text-white py-1 px-2 rounded appearance-none w-full text-center text-xs sm:text-sm;
