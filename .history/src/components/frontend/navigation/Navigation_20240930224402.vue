        ...
        <div class="items-center hidden space-x-4 md:flex">
          ...
          <div class="relative flex flex-col items-center">
            ...
            <div class="flex items-center mt-1">
              ...
              <select v-model="selectedLanguage" @change="handleLanguageChange" class="ml-1 text-white bg-site-bg hover:bg-site-bg nav-select">
          ...
          <div class="mb-4 nav-item">
            <div class="flex flex-col items-center">
              ...
              <div class="flex items-center">
                <span class="text-xs">Traduction</span>
                <select v-model="selectedLanguage" @change="handleLanguageChange" class="ml-1 text-white bg-yellow-200 bg-opacity-50 hover:bg-yellow-300 nav-select">
                  <option value="fr">FR</option>
                  <option value="en">EN</option>
                </select>
              </div>
