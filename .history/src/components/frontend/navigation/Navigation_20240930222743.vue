        ...
        <div class="items-center hidden space-x-4 md:flex">
          ...
          <div class="flex flex-col items-center relative">
            ...
            <div class="flex items-center mt-1">
              <select v-model="selectedLanguage" @change="handleLanguageChange" class="text-white bg-gray-700 nav-select hover:bg-gray-600">
                <option value="fr">FR</option>
                <option value="en">EN</option>
              </select>
              <span class="text-xs ml-1">Traduction</span>
            </div>
          </div>
        </div>
          ...
          <div class="mb-4 nav-item">
            <div class="flex flex-col items-center">
              ...
              <div class="flex items-center">
                ...
                <select v-model="selectedLanguage" @change="handleLanguageChange" class="ml-1 text-white bg-gray-700 nav-select hover:bg-gray-600">
                  <option value="fr">FR</option>
                  <option value="en">EN</option>
                </select>
              </div>
