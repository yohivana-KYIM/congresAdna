<template>
  <section class="py-12 bg-site-bg">
    <div class="container px-0 mx-auto"> <!-- Retirer le padding horizontal -->
      <div class="relative">
        <div class="flex overflow-x-hidden" ref="slider">
          <div class="flex w-full">
            <div
              ...
              :key="index"
              class="w-full mb-0 md:w-1/3" <!-- Retirer le padding en bas -->
            >
              <div class="flex flex-col justify-between h-full text-center transition-transform duration-300 transform bg-white rounded-lg shadow-lg hover:shadow-xl">
                <div class="relative">
                  <img
