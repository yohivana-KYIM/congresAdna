        ...
        <div class="flex overflow-x-hidden" ref="slider">
          <div class="flex w-full">
            <div
              ...
              :key="index"
              class="w-full px-2 mb-0 md:w-1/3" <!-- Pas de marge inférieure ici -->
            >
              <div class="flex flex-col justify-between h-full p-6 text-center transition-transform duration-300 transform bg-white border border-gray-300 rounded-lg shadow-lg hover:shadow-xl">
                <div class="relative">
                  <img
                    :src="`/images/${slide.image}`"
                    :alt="'Image ' + (index + 1)"
                    class="object-cover w-full h-40 transition-transform duration-300 transform rounded-t-lg hover:scale-105" <!-- Pas de marge inférieure -->
                  />
                  <h3
