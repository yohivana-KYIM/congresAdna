    ...
    <div class="container px-4 mx-auto">
      <div class="relative">
        <div class="flex overflow-x-hidden" ref="slider">
          <div class="flex w-full">
            ...
            >
              <div class="flex flex-col justify-between h-full p-6 text-center bg-white rounded-lg shadow-lg transition-transform duration-300 transform hover:shadow-xl">
                <div class="relative">
                  <img
                    :src="`/images/${slide.image}`"
                    :alt="'Image ' + (index + 1)"
                    class="object-cover w-full h-40 mb-4 rounded-t-lg transition-transform duration-300 transform hover:scale-105"
                  />
                  <h3
                ...
                <a
                  href="#"
                  class="inline-block px-4 py-2 mt-4 text-center text-white bg-blue-600 rounded-lg transition-colors duration-300 hover:bg-blue-700"
                >
                  Voir Plus
                </a>
              </div>
      ...
      <div class="flex justify-center mt-4">
        <button
          ...
          class="w-3 h-3 mx-1 rounded-full focus:outline-none transition-colors duration-300"
        ></button>
      </div>
    </div>
  </section>
