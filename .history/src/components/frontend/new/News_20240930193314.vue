          ...
          <div class="flex w-full">
            ...
            >
              <div class="flex flex-col justify-between h-full p-6 text-center transition-transform duration-300 transform bg-white rounded-lg shadow-lg hover:shadow-xl">
                <div class="relative h-48"> <!-- Hauteur définie pour le conteneur -->
                  <img
                    :src="`/images/${slide.image}`"
                    :alt="'Image ' + (index + 1)"
                    class="object-cover w-full h-full transition-transform duration-500 ease-in-out transform cursor-pointer hover:scale-110"
                  />
                  <h3
