      ...
      <div class="relative">
        <div class="flex overflow-x-hidden" ref="slider">
          <div class="flex w-full">
            ...
            >
              <div class="flex flex-col justify-between h-full p-6 text-center transition-transform duration-300 transform bg-white border border-gray-300 rounded-lg shadow-lg hover:shadow-xl"> <!-- Ajout d'une bordure -->
                <div class="relative">
                  <img
                    :src="`/images/${slide.image}`"
                    :alt="'Image ' + (index + 1)"
                    class="object-cover w-full h-40 mb-2 mb-4 transition-transform duration-300 transform rounded-t-lg hover:scale-105" <!-- Ajout d'une marge inférieure -->
                  />
                  <h3
