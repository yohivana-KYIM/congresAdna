              ...
              <div class="flex flex-col justify-between h-full p-6 text-center transition-transform duration-300 transform bg-white rounded-lg shadow-lg hover:shadow-xl">
                <div class="relative">
                  <img
                    ...
                    :alt="'Image ' + (index + 1)"
                    class="object-cover w-full h-40 mb-4 transition-transform duration-300 transform rounded-lg hover:scale-105" <!-- Changement ici pour arrondir complètement l'image -->
                  />
                  <h3
