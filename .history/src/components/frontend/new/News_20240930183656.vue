<template>
  <section class="py-12 bg-site-bg">
    <div class="container mx-auto">
      <!-- Section d'image avec titre et description -->
      <div class="relative flex items-center justify-center mb-8">
        <div class="relative">
          <img
            src="path/to/your/image.jpg" <!-- Remplacez ce chemin par le chemin de votre image -->
            alt="Description de l'image"
            class="object-cover w-full transition-transform duration-300 transform rounded-lg shadow-lg h-80 hover:scale-105"
          />
          <div class="absolute bottom-0 left-0 w-full p-4 text-white bg-black bg-opacity-50 rounded-b-lg">
            <h3 class="text-lg font-semibold">Titre de l'image</h3>
            <p class="text-sm">Description de l'image ou du service proposé.</p>
          </div>
        </div>
      </div>
              ...
              <div class="flex flex-col justify-between h-full p-6 text-center transition-transform duration-300 transform bg-white rounded-lg shadow-lg hover:shadow-xl">
                <div class="relative">
                  <img
                    ...
                    :alt="'Image ' + (index + 1)"
                    class="object-cover w-full h-40 transition-transform duration-300 transform rounded-lg hover:scale-105"
                  />
                  <h3
